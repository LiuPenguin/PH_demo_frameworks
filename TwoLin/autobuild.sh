...
#  TwoLin
#
#  Created by liupenghui on 2021/2/20.
#  
...
PROJECT_NAME="TwoLin.xcodeproj"
PROJECT_SCHEME="TwoLin"
TARGET_NAME="TwoLin"
...
sed -i "" "s/SDK_WIMLib_BuildTime.*/${im_build_time}/g" ./TwoLin/BuildVersion.h

im_version="SDK_WIMLib_Version @\"${VER_FLAG}\""
sed -i "" "s/SDK_WIMLib_Version.*/${im_version}/g" ./TwoLin/BuildVersion.h
